...
# What is Module?
# if you want to build multiple environments we need to use modules
# we can create multiple environments with resources very easy way

# if want to destroy specific environment, the command is terraform destroy --target=module.module_uat
